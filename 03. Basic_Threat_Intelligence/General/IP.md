...
- Mặc phẳng điều khiển (Control Plane): Thực hiện chức năng định tuyến (routing), xác định lộ trình từ đầu đến cuối mà gói tin sẽ đi qua thông qua các thuật toán định tuyến. *(đây là chức năng cho toàn mạng)*
...
- Thuật toán trạng thái liên kết (Link-State LS): Là thuật toán tập trung, yêu cầu thông tin đầy đủ về toàn bộ cấu trúc mạng để tính toán. Sử dụng thuật toán Dijkstra, giúp tìm đường đi ngắn nhất từ một nút nguồn đến các nút khác.
